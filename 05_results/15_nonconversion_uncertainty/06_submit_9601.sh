...
#SBATCH --job-name=mC_on_9601
#SBATCH --qos=short
#SBATCH --time=8:00:00
#SBATCH --mem=80gb
#SBATCH --output=slurm/mC_on_9601.%a.out
#SBATCH --error=slurm/mC_on_9601.%a.err
#SBATCH --array=0-3
...
files=(04_output/30x_9601/bismark_meths/cx_report/*CX_report.txt.gz)

# File for this job
infile=${files[$SLURM_ARRAY_TASK_ID]}
# Output directory
outdir=05_results/15_nonconversion_uncertainty/output/6901
mkdir -p $outdir
